...
void __fastcall TForm1::Button1Click(TObject *Sender)
{
	...
	client->Port=502;                       //Paramètres de connexion du clien
	client->Connect();
